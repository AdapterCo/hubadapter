    ...
    <div className="page-content">
      ...
      <div className="card" style={{ marginBottom: '20px' }}>
        ...
        <div className="alert alert-info" style={{ marginTop: '16px' }}>
          <span>ℹ️</span>
          <div>
            <strong>Como configurar:</strong> No painel do MercadoPago → Seu negócio → Configurações → Notificações (webhooks / IPN) → Cole a URL acima.
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '16px' }}>
          Necessário para consultar e validar os pagamentos recebidos da sua máquina de cartão com total segurança. Encontre em: Seu negócio → Credenciais → Access Token de Produção.
        </p>
        {saved && <div className="alert alert-success">✅ Access Token salvo com sucesso!</div>}
        <form onSubmit={saveMpToken}>
          <div className="form-group">
            ...
            />
            <span className="form-hint">O token é armazenado de forma criptografada (AES-256) no servidor e nunca é exibido completo</span>
          </div>
